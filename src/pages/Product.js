...
const Product = () => {
    ...
    return (
        <Container>
            <Row>
                <Col sm={5}>
                    <Image className="mt-5" width="480" height="320" src={product.picture}></Image>
                </Col>
                <Col sm={7} className="mt-5  text-white">
                    ...
                    <h4>Средний рейтинг пользователей: {product.rating}🌟</h4>
                    {isAuth ? <Button variant="primary">Добавить в корзину</Button> : <p>Авторизуйтесь, чтобы добавить в корзину</p>}
                </Col>
            </Row>
            <Row className="mt-2">
